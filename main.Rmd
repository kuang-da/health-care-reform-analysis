...
In this report, we will first describe the dataset and how to organize them as the systematic components, introduce econometric models like [TBD]. After fitting the model to the dataset, we will analyze and discuss the results.
