...
From the histograms above, we can observe that there are a large amount of $0$ in the data, and overall the number of 0 increases from 1996 to 1998. Most notably, we can see a decrease in frequency for number of visits between 1 to 13.
